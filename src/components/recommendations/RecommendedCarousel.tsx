...
export default function RecommendedCarousel({ brands }: Props) {
  ...
  return (
    <div className="w-full bg-zinc-900/50 border-y border-zinc-800/50 py-5 mb-2">
      <div className="w-full max-w-6xl mx-auto px-4">
        <div className="flex items-center gap-2 mb-3">
          <div className="w-1 h-3.5 rounded-full bg-indigo-500" />
          <h2 className="text-white text-sm font-semibold tracking-widest uppercase opacity-80">
            Recommended for you
          </h2>
        </div>
